        ...
        <div className="footer-content">
          <div className="branding-left">
            <div className="entity-group">
              <span className="label-tiny">{t.footer.peoplesInitiative}</span>
              <img
                src="https://flagcdn.com/w80/tn.png"
                className="tn-flag-mini"
                alt={t.footer.flagAlt}
              />
            </div>
            ...
            <div className="forum-logo-wrap">
              ...
              <div className="entity-group">
                <span className="label-tiny" style={{ color: '#888' }}>
                  {t.footer.promoter}
                </span>
                <span className="forum-text">{t.footer.youthForum}</span>
              </div>
            </div>
          </div>

          <div className="center-stack">
            <div className="signature-block">Project X 2026</div>
